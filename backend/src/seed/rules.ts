const rules = [
  // Rule 1: Flag High-Value International Transactions
  {
    rule_name: 'HIGH_VALUE_INTERNATIONAL',
    rule_description:
      'Flags transactions over $10,000 involving high-risk countries.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'HIGH',
    rule_weight: 0.8,
    ...
    parameters: [
      ...
      },
      {
        ...
        operator: 'IN',
        value: JSON.stringify(['SY', 'KP', 'IR']), // High-risk countries (Syria, North Korea, Iran)
        value_type: 'VALUE',
      },
    ],
    time_windows: [],
  ...
  // Rule 2: Block Rapid High-Frequency Transactions (Velocity Check)
  {
    rule_name: 'HIGH_FREQUENCY_TRANSACTIONS',
    rule_description:
      'Blocks accounts with more than 5 transactions within 24 hours.',
    is_active: true,
    rule_type: 'OR',
  ...
  // Rule 3: Escalate Transactions by PEPs
  {
    rule_name: 'PEP_TRANSACTION',
    rule_description:
      'Escalates transactions involving Politically Exposed Persons (PEPs).',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'HIGH',
    rule_weight: 0.9,
    ...
    rule_actions: [
      {
        action: 'ESCALATE',
        details:
          'Transaction by PEP with amount >= $5000 escalated for review.',
      },
    ],
  },

  // Rule 4: Hold Transactions with Adverse Media
  {
    rule_name: 'ADVERSE_MEDIA_TRANSACTION',
    rule_description:
      'Holds transactions for customers with adverse media records.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'MEDIUM',
    rule_weight: 0.7,
  ...
  // Rule 5: Flag Suspicious Counterparty Patterns
  {
    rule_name: 'SUSPICIOUS_COUNTERPARTY',
    rule_description:
      'Flags transactions with counterparties in high-risk countries or unusual names.',
    is_active: true,
    rule_type: 'OR',
    rule_severity: 'MEDIUM',
    rule_weight: 0.5,
  ...
  // Rule 1: Cash Spreading (Existing Rule)
  {
    rule_name: 'CASH_SPREADING',
    rule_description:
      'Detects multiple small cash deposits to avoid reporting thresholds (e.g., under $10,000 USD in 24 hours).',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'MEDIUM',
    rule_weight: 0.7,
    risk_score_value: 70,
    currency_context: 'USD', // Rule-level currency filter
    parameters: [
      {
  ...
  // Rule 2: High-Value Single Transaction (Existing Rule)
  {
  ...
  // Rule 3: Unusual Transaction Frequency (Existing Rule)
  {
    rule_name: 'UNUSUAL_TRANSACTION_FREQUENCY',
    rule_description:
      'Detects accounts with more than 10 transactions in a week, unusual for individual accounts.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'MEDIUM',
    rule_weight: 0.6,
    risk_score_value: 60,
    currency_context: null, // Applies to all currencies
    parameters: [
      {
        key: 'TRANSACTION_COUNT',
        operator: 'GT',
  ...
  // Rule 4: Round Number Transactions (Existing Rule)
  {
    rule_name: 'ROUND_NUMBER_TRANSACTIONS',
    rule_description:
      'Flags transactions with round amounts (e.g., $1000, $5000) in USD or EUR, indicative of potential structuring.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'MEDIUM',
    rule_weight: 0.5,
    risk_score_value: 50,
    currency_context: null, // Currency as parameter
    parameters: [
      {
        key: 'TRANSACTION_AMOUNT',
        operator: 'IN',
  ...
  // Rule 5: High-Value International Transfer
  {
    rule_name: 'HIGH_VALUE_INTERNATIONAL_TRANSFER',
    rule_description:
      'Flags international transfers over $50,000 to high-risk countries.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'HIGH',
    rule_weight: 0.9,
  ...
  // Rule 6: PEP High-Value Transaction
  {
  ...
  // Rule 7: Adverse Media Transaction
  {
    rule_name: 'ADVERSE_MEDIA',
    rule_description:
      'Holds transactions for customers with adverse media records over $5,000 EUR.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'MEDIUM',
    rule_weight: 0.7,
  ...
  // Rule 8: Suspicious Counterparty Country
  {
    rule_name: 'SUSPICIOUS_COUNTERPARTY_COUNTRY',
    rule_description:
      'Flags transactions with counterparties in high-risk countries.',
    is_active: true,
    rule_type: 'OR',
    rule_severity: 'MEDIUM',
    rule_weight: 0.6,
  ...
  // Rule 9: Dormant Account Activity
  {
    rule_name: 'DORMANT_ACCOUNT_ACTIVITY',
    rule_description:
      'Flags sudden activity in dormant accounts with transactions over $2,000.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'MEDIUM',
    rule_weight: 0.6,
  ...
  // Rule 10: High-Risk Customer Transaction
  {
    rule_name: 'HIGH_RISK_CUSTOMER',
    rule_description:
      'Escalates transactions by high-risk customers over $3,000.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'HIGH',
    rule_weight: 0.8,
  ...
  // Rule 12: Multiple Currency Transactions
  {
    rule_name: 'MULTIPLE_CURRENCY_TRANSACTIONS',
    rule_description:
      'Flags accounts with transactions in 3+ currencies within a week.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'MEDIUM',
    rule_weight: 0.6,
    ...
    parameters: [
      {
        key: 'CURRENCY',
        operator: 'NOT_IN',
        value: JSON.stringify([]), // Count distinct currencies
        value_type: 'VALUE',
      },
    ],
    time_windows: [
  ...
  // Rule 13: New Account High Activity
  {
    rule_name: 'NEW_ACCOUNT_HIGH_ACTIVITY',
    rule_description:
      'Flags new accounts (less than 30 days old) with transactions over $5,000.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'MEDIUM',
    rule_weight: 0.6,
  ...
  // Rule 14: Suspicious Counterparty Name
  {
    rule_name: 'SUSPICIOUS_COUNTERPARTY_NAME',
    rule_description:
      'Flags transactions with counterparty names containing suspicious keywords.',
    is_active: true,
    rule_type: 'OR',
    rule_severity: 'MEDIUM',
    rule_weight: 0.5,
  ...
  // Rule 15: Exceeded Daily Limit
  {
    rule_name: 'EXCEEDED_DAILY_LIMIT',
    rule_description:
      "Blocks transactions exceeding the customer's daily limit.",
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'HIGH',
    rule_weight: 0.8,
    ...
    parameters: [
      {
        key: 'TRANSACTION_AMOUNT',
        operator: 'GT',
        value: 'DAILY_LIMIT', // Assumes DAILY_LIMIT is a dynamic field
        value_type: 'NUMBER',
      },
    ],
    time_windows: [],
  ...
  // Rule 16: High Transaction Hour
  {
    rule_name: 'HIGH_TRANSACTION_HOUR',
    rule_description:
      'Flags transactions outside normal hours (midnight to 6 AM).',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'MEDIUM',
    rule_weight: 0.5,
  ...
  // Rule 17: Low Balance High Transaction
  {
    rule_name: 'LOW_BALANCE_HIGH_TRANSACTION',
    rule_description:
      'Flags transactions where amount exceeds account balance.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'HIGH',
    rule_weight: 0.8,
    ...
    parameters: [
      {
        key: 'TRANSACTION_AMOUNT',
        operator: 'GT',
        value: 'ACCOUNT_BALANCE', // Dynamic comparison
        value_type: 'NUMBER',
      },
    ],
    time_windows: [],
  ...
  // Rule 18: Rapid Fund Transfers
  {
    rule_name: 'RAPID_FUND_TRANSFERS',
    rule_description:
      'Detects multiple transfers within 48 hours totaling over $20,000.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'MEDIUM',
    rule_weight: 0.7,
  ...
  // Rule 19: Suspicious Source of Funds
  {
    rule_name: 'SUSPICIOUS_SOURCE_OF_FUNDS',
    rule_description:
      'Flags transactions with unclear or suspicious source of funds.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'MEDIUM',
    rule_weight: 0.6,
  ...
  // Rule 20: High-Risk Transaction Channel
  {
    rule_name: 'HIGH_RISK_TRANSACTION_CHANNEL',
    rule_description:
      'Flags high-value transactions through mobile channels in EUR.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'MEDIUM',
    rule_weight: 0.6,
  ...
  // Rule 1: Aggregated Structured Cash Deposits
  {
    rule_name: 'AGGREGATED_CASH_DEPOSITS',
    rule_description:
      'Flags daily aggregated cash deposits exceeding $10,000 for all customers.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'MEDIUM',
    rule_weight: 0.7,
  ...
  // Rule 2: High-Risk Country Citizen Transactions
  {
    rule_name: 'HIGH_RISK_CITIZEN_TRANSACTIONS',
    rule_description:
      'Flags all transactions by customers from high-risk countries.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'HIGH',
    rule_weight: 0.8,
    ...
    parameters: [
      {
        key: 'CUSTOMER_CITIZENSHIP', // Assumes citizenship is available; otherwise, use CUSTOMER_RISK_RATING or similar
        operator: 'IN',
        value: JSON.stringify(['SY', 'KP', 'IR']),
        value_type: 'VALUE',
      },
    ...
    time_windows: [
      {
        ...
        aggregation_type: 'COUNT',
        key: 'TRANSACTION_COUNT',
        threshold: JSON.stringify({ value: 1 }), // Any transaction triggers
      },
    ],
    rule_actions: [
      {
      ...
      },
      {
        action: 'ALERT',
        details:
          'Notify compliance for review of high-risk citizen transaction.',
      },
    ],
  },

  // Rule 3: PEP Credit Transactions
  {
    ...
    parameters: [
      ...
      },
      {
        key: 'TRANSACTION_TYPE',
        operator: 'IN',
        value: JSON.stringify(['Deposit', 'Incoming Transfer']), // Assuming credit transactions include deposits and incoming transfers
        value_type: 'VALUE',
      },
      {
        key: 'TRANSACTION_AMOUNT',
    ...
    time_windows: [
      {
        ...
        aggregation_type: 'COUNT',
        key: 'TRANSACTION_COUNT',
        threshold: JSON.stringify({ value: 1 }), // Any matching transaction triggers
      },
    ],
    rule_actions: [
      {
        action: 'ESCALATE',
        details:
          'PEP credit transaction exceeding $5,000 escalated for review.',
      },
    ],
  },

  // Rule 4: Non-Profit Cash Deposits
  {
    rule_name: 'NON_PROFIT_CASH_DEPOSITS',
    rule_description:
      'Flags cash deposits by non-profit organizations exceeding $1,000.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'MEDIUM',
    rule_weight: 0.6,
  ...
  // Rule 5: Wire Transfer Thresholds
  {
    rule_name: 'WIRE_TRANSFER_THRESHOLDS',
    rule_description:
      'Flags wire transfers exceeding $20,000 for individuals or $100,000 for corporates weekly.',
    is_active: true,
    rule_type: 'OR',
    rule_severity: 'HIGH',
    rule_weight: 0.8,
  ...
  // Rule 6: Minor High Transaction Frequency
  {
    rule_name: 'MINOR_HIGH_FREQUENCY',
    rule_description:
      'Flags minors with transaction frequency exceeding 20 per week.',
    is_active: true,
    rule_type: 'AND',
    rule_severity: 'MEDIUM',
    rule_weight: 0.6,
    ...
    parameters: [
      {
        key: 'CUSTOMER_AGE', // Assumes age is available; otherwise, a new field or derived parameter is needed
        operator: 'LT',
        value: '18',
        value_type: 'NUMBER',
      },
  ...
  },
  {
    ...
    rule_description:
      'Flags transactions associated with forged, expired, or multiple IDs.',
    is_active: true,
    rule_type: 'OR',
    rule_severity: 'HIGH',
    rule_weight: 0.9,
  ...
  // New Rule: Unexplained Large Foreign Exchange or Pattern Change
  {
    rule_name: 'UNEXPLAINED_FOREX_PATTERN_CHANGE',
    rule_description:
      'Flags large foreign exchange transactions or sudden changes in transaction patterns.',
    is_active: true,
    rule_type: 'OR',
    rule_severity: 'MEDIUM',
    rule_weight: 0.7,
    ...
    rule_actions: [
      {
        action: 'FLAG',
        details:
          'Unexplained large foreign exchange or pattern change detected.',
      },
      {
        action: 'ALERT',
