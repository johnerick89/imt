...
export class TransactionService {
    ...
    try {
      return await prisma.$transaction(async (tx) => {
        ...
        if (data.origin_country_id) {
          ...
          if (
            customerCountryId &&
            customerCountryId !== data.origin_country_id
          ) {
            throw new Error(
  ...
  async getInboundTransactionById(
    ...
    try {
      ...
      throw new Error("Failed to fetch inbound transaction");
    }
  }
  ...
  async approveInboundTransaction(
    ...
    try {
      ...
      throw new Error("Failed to approve inbound transaction");
    }
  }
  ...
  async reverseInboundTransaction(
    ...
    try {
      ...
      throw new Error("Failed to reverse inbound transaction");
    }
  }
  ...
  private async createGLTransactionForApprovedInboundTransaction(
    ...
    try {
      ...
      console.error(
        "Error creating GL transaction for approved inbound transaction:",
        error
      );
      throw new Error("Failed to create GL transaction");
    }
  ...
  async getInboundTransactionStats(
    ...
    try {
      ...
      throw new Error("Failed to fetch inbound transaction stats");
    }
  }
}
