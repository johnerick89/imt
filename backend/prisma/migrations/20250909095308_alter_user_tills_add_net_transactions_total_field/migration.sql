/*
  ...
  - The values [TILL_BALANCE,VAULT_BALANCE] on the enum `BalanceHistoryType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."BalanceHistoryType_new" AS ENUM ('ORG_BALANCE', 'TILL', 'VAULT', 'BANK_ACCOUNT');
