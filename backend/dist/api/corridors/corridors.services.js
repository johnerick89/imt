...
class CorridorService {
    async createCorridor(data, userId) {
        try {
    ...
    async getCorridors(filters) {
        try {
            const { page = 1, limit = 10, search, status, base_country_id, destination_country_id, base_currency_id, organisation_id, created_by, } = filters;
...
//# sourceMappingURL=corridors.services.js.map